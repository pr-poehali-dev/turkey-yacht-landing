...
const YACHT_TYPES: YachtDetail[] = [
  ...
  },
  {
    ...
    fullDesc: "Dufour 455 — французская элегантность на воде. Эта яхта создана для тех, кто ценит простор и комфорт. Увеличенные каюты с отдельными санузлами, широкий кокпит с двумя штурвалами и большая носовая площадка для загара. Панорамные окна в салоне наполняют пространство светом. Просторная кухня позволяет готовить полноценные ужины.",
    specs: ["Просторные каюты с отдельными санузлами", "2 туалета с душем на борту", "Душ с пресной водой на купальной платформе", "Больше места на палубе", "Два штурвала", "Носовая площадка для загара", "Панорамные окна в салоне", "Электрическая лебёдка"],
    detailedSpecs: [
