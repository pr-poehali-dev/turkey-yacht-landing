...
const YACHT_TYPES: YachtDetail[] = [
  ...
  },
  {
    ...
    specs: ["3 каюты с двуспальными кроватями", "До 6 гостей + капитан", "2 туалета с душем на борту", "Душ с пресной водой на купальной платформе", "Большой кокпит с шатром и обеденным столом", "Новые современные паруса", "Просторный холодильник с морозильной камерой", "Два штурвала", "Носовая площадка для загара", "SUP-борд", "Маски, ласты для снорклинга", "Снасти для рыбалки", "Динги с мотором", "Электрическая лебёдка"],
    detailedSpecs: [
  ...
  },
  {
    ...
    specs: ["4 каюты с индивидуальными санузлами", "До 8 гостей + капитан", "Минимальная качка — два корпуса", "Огромный кокпит и салон", "Зона отдыха с подушками на носовой платформе", "Трамплинная сетка на носу", "Каяк", "SUP-борд", "Подводные скутеры", "Ледогенератор", "Кофемашина — по запросу"],
    detailedSpecs: [
      { label: "Длина", value: "14.2 м" },
